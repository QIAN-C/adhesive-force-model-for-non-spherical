...
struct ParticleProps
{
    ...
    double  m;    ///< Mass
		    ...
		    double  number;    ///< panduan jingzhi
		    bool   interact;    //2022.03.26 by qian
		   bool fixedparticle;	//2022.03.26 by qian
		  bool ready_fixedparticle; //2022.04.01

           double	   particle_radius;	///< ***************************************2022.01.08
...
inline void Particle::init_default_values(int tag, double r, double rho)
{
    ...
    Props.Beta = 0.12;
    Props.Eta  = 1.0;
    Props.R    = r;   //this is the erosion radius
    Props.rho  = rho;
	
	Props.number  = 0;//2022.03.24	by qian
	Props.interact= false;//2022.03.26  by qian
	Props.fixedparticle=false;////2022.03.26  by qian
	Props.ready_fixedparticle=false;//2022.04.01

	Props.particle_radius=1.415;    // in order to distinguish the particle radius from  erosion radius,  and this is the particle radius. but we shouled definitied in the begion, by qian 2022.01.08
        Props.E=2.0e4; //***************************************by qian
	Props.Sig=0.33;//***************************************by qian
	Props.G=Props.E/(2*(1+Props.Sig));//***************************************by qian 
	Props.Gama=1;//***************************************by qian
...
inline void Particle::FixVeloc (double vx, double vy, double vz)
{
	...
	Props.fixedparticle=true;
	Props.ready_fixedparticle=true;//2022.04.01
}
